...
const Services = ({ isDarkMode }) => {
  return (
    <div id='services' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      <h2 className='text-center text-5xl font-roboto'>My Services</h2>
      ...
      <div className='grid grid-cols-auto gap-6 my-10'>
        {serviceData.map(({icon, title, description, link}, index)=>(
            <div key={index} className={`border border-gray-400 rounded-lg px-8 py-12 cursor-pointer hover:-translate-y-1 duration-500 ${isDarkMode ? "hover:bg-(--color-darkHover) hover:shadow-(--box-shadow-light)" : "hover:bg-(--color-lightHover) hover:shadow-(--box-shadow-black)"}`}>
